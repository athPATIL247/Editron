      ...
      <div className="login-container">
        ...
        <div className="right">
          <div className="right-content">
            ...
            <p>
              {signup
                ? "Join our coding community and start collaborating"
            ...
            {signup && (
              ...
              >
                <div className="form-data">
                  ...
                  <input
                    type="text"
                    placeholder="Enter username (e.g., coder123)"
                    required
                ...
                <div className="form-data">
                  ...
                  <input
                    type="email"
                    placeholder="Enter email (e.g., coder123@gmail.com)"
                    required
                ...
                <p>
                  ...
                  <span onClick={() => setSignup(!signup)}>Log in</span>
                </p>
              </form>
            )}
            ...
            {!signup && (
              ...
              >
                <div className="form-data">
                  ...
                  <input
                    type="text"
                    placeholder="eg. coder123@gmail.com"
                    required
                    value={formData.email}
                    onChange={(e) =>
                      setFormData({ ...formData, email: e.target.value })
